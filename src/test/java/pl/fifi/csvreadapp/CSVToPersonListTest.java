...
class CSVToPersonListTest {
    ...
    public void shouldCreateNewPerson(){
        ...
        csvToPersonList.addPerson(6,"Andrew","Andree",12311231121L);
    ...
    public void shouldThrowRuntimeExceptionWhenNameIsNull() {
        Assertions.assertThrows(RuntimeException.class,()->{csvToPersonList.addPerson(6,null,"Andree",12311231121L);
        });
    }
    ...
    public void shouldThrowRuntimeExceptionWhenSurnameIsNull() {
        Assertions.assertThrows(RuntimeException.class,()->{csvToPersonList.addPerson(6,"Andrew",null,12311231121L);
        });
    }
    ...
    public void shouldThrowRuntimeExceptionWhenPhoneIsNull() {
        Assertions.assertThrows(RuntimeException.class,()->{csvToPersonList.addPerson(6,"Andrew","Andree",null);
        });
    }
    @Test
    ...
    public void shouldThrowRuntimeExceptionWhenPhoneHasTenDigits() {
        Assertions.assertThrows(RuntimeException.class,()->{csvToPersonList.addPerson(6,"Andrew","Andree",1234567891L);
        });
    }
    @Test
